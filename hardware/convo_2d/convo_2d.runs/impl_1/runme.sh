...
HD_PWD='/home/idris/projects/FPGA_VISION/NN_SHIFT/hardware/convo_2d/convo_2d.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log conv_2d_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source conv_2d_top.tcl -notrace
