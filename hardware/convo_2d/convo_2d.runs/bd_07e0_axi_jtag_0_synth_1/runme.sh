...
HD_PWD='/home/idris/projects/FPGA_VISION/NN_SHIFT/hardware/convo_2d/convo_2d.runs/bd_07e0_axi_jtag_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_07e0_axi_jtag_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_07e0_axi_jtag_0.tcl
