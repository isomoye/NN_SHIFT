...
HD_PWD='/home/idris/projects/FPGA_VISION/NN_SHIFT/hardware/convo_2d/convo_2d.runs/system_wrapper_axi_bram_ctrl_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_wrapper_axi_bram_ctrl_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_wrapper_axi_bram_ctrl_0_1.tcl
