...
HD_PWD='/home/idris/projects/FPGA_VISION/NN_SHIFT/hardware/RAM_NN/RAM_NN.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_nn.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ram_nn.tcl -notrace
