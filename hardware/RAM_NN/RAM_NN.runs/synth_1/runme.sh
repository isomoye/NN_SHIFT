...
HD_PWD='/home/idris/projects/FPGA_VISION/NN_SHIFT/hardware/RAM_NN/RAM_NN.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_nn.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram_nn.tcl
